...
class ArcII(BaseModel):
    ...
    def build(self):
        ...
        embed_flat = layers.Flatten()(embed_cross)
        x = layers.Dropout(rate=self._params['dropout_rate'])(embed_flat)
    ...
    def _conv_pool_block(
        ...
        output = layers.Conv2D(kernel_count,
                               kernel_size,
                               padding=padding,
